...
const handleClose = useCallback(() => {
  ...
  const alertConfig = {
    success: {
      ...
      text: 'text-green-700',
      icon: (
        <svg className="w-6 h-6 mt-28 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    error: {
      ...
      text: 'text-red-700',
      icon: (
        <svg className="w-6 h-6 mt-28 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    warning: {
      ...
      icon: (
        <svg className="w-6 h-6 mt-28 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    info: {
      ...
      text: 'text-blue-700',
      icon: (
        <svg className="w-6 h-4 mt-28 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
